...
public class SceneManager : MonoBehaviour
{
    ...
    paceNameAndTime[] paces;
    // Start is called before the first frame update
    void Start()
    {
        paces = new paceNameAndTime[]{
        new paceNameAndTime("Jog", new Color32(139,192,139,255), 30, pacesAudio[0]),
        new paceNameAndTime("Race Pace", new Color32(73,145,73, 255), 30, pacesAudio[1]),
        new paceNameAndTime("Sprint", new Color32(243, 33, 27, 255), 10, pacesAudio[2])};
...
public class paceNameAndTime
{
    public string name;
    public float time;
    public Color color;
    public AudioClip audio;
    public paceNameAndTime(string _name, Color _color, int _time, AudioClip _audio)
    {
        name=_name;
        time=_time;
        color=_color;
